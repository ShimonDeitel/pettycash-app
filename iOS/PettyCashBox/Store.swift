...
final class Store: ObservableObject {
    ...
    private let fileName = "pettycash_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Transaction One", detail: "First example entry.", date: now),
            Entry(title: "Sample Transaction Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Transaction Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
