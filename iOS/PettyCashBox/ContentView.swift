...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Petty - Cash Box")
            .toolbar {
            ...
            .overlay {
                if store.entries.isEmpty {
                    ContentUnavailableView("No Transactions Yet", systemImage: "tray", description: Text("Tap + to add your first entry."))
                }
            }
        ...
        NavigationStack {
            Form {
                Section("Transaction") {
                    ...
                    TextField("Details (amount, recorded by)", text: $detail)
